...
class CHECKERCHECKOUTTB: UITabBarController,MDCBottomNavigationBarDelegate {
  ...
  func commonBottomNavigationTypicalUseSwiftExampleInit()
  {
      ...
      let tabBarItem1 = UITabBarItem( title: "Product",  image: UIImage(named: "products"), tag: 0 )
      let tabBarItem2 = UITabBarItem( title: "Equipment",   image: UIImage(named: "equipments"), tag: 1 )
      let tabBarItem3 = UITabBarItem( title: "Confirm", image: UIImage(named: "checker"), tag: 2 )
