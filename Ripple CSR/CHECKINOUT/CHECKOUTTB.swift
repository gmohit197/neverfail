...
class CHECKOUTTB: UITabBarController,MDCBottomNavigationBarDelegate {
  ...
  func commonBottomNavigationTypicalUseSwiftExampleInit()
  {
      ...
      let tabBarItem1 = UITabBarItem( title: "Products",   image: UIImage(named: "products"), tag: 0 )
      let tabBarItem2 = UITabBarItem( title: "Equipments",   image: UIImage(named: "equipments"), tag: 1 )
      let tabBarItem3 = UITabBarItem( title: "DLA", image: UIImage(named: "dla"), tag: 2 )
       let tabBarItem4 = UITabBarItem( title: "SelfChecker", image: UIImage(named: "selfchecker"), tag: 3 )
